...
class MovieDetailModel extends MovieDetailEntity {
  ...
  factory MovieDetailModel.fromMap(Map<String, dynamic> json) =>
      MovieDetailModel(
        ...
        genres:(json["genres"] as List).map((x) => Genre.fromMap(x)).toList(),
        ...
        productionCompanies:(json["production_companies"] as List).map((x) => ProductionCompany.fromMap(x)).toList(),
        productionCountries: (json["production_countries"] as List).map((x) => ProductionCountry.fromMap(x)).toList(),
        releaseDate: json["release_date"] ?? '', 
        revenue: json["revenue"] ?? 0,
        runtime: json["runtime"] ?? 0,
        spokenLanguages: (json["spoken_languages"] as List).map((x) =>SpokenLanguage.fromMap(x)).toList(),
        status: json["status"] ?? '',
